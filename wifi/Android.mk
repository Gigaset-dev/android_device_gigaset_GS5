...
include $(CLEAR_VARS)
LOCAL_MODULE := android.hardware.wifi-service-lazy.GS5.rc
...
include $(CLEAR_VARS)
LOCAL_MODULE := android.hardware.wifi-service.GS5.xml
LOCAL_MODULE_TAGS  := optional
LOCAL_MODULE_CLASS := ETC
...
include $(CLEAR_VARS)
LOCAL_MODULE := android.hardware.wifi-service-lazy.GS5
...
LOCAL_REQUIRED_MODULES := \
    android.hardware.wifi-service-lazy.GS5.rc \
    android.hardware.wifi-service.GS5.xml
